...
const ApintoGuide: DefaultTheme.SidebarItem[] = [
  ...
  },
  {
    ...
    collapsed: true,
    items: [
      { text: 'ErrorLog', link: '/docs/apinto/system/error_log' },
    ],
  },
  {
    text: '路由',
...
const DashboardGuide: DefaultTheme.SidebarItem[] = [
...

  {
    ...
    collapsed: true,
    items: [
      { text: '额外参数', link: '/docs/dashboard/plugins/extra_params' },
      { text: '参数映射', link: '/docs/dashboard/plugins/params_transformer' },
      { text: '转发重写', link: '/docs/dashboard/plugins/proxy_rewrite' },
      { text: '转发重写 V2', link: '/docs/dashboard/plugins/proxy_rewrite_v2' },
      { text: 'http_mocking', link: '/docs/dashboard/plugins/http-mocking' },
      { text: 'dubbo2 协议转发重写', link: '/docs/dashboard/plugins/dubbo2-proxy-rewrite' },
      { text: 'http 协议转 dubbo2 协议插件', link: '/docs/dashboard/plugins/http-to-dubbo2' },
      { text: 'dubbo2 协议转 http 协议插件', link: '/docs/dashboard/plugins/dubbo2-to-http' },
      { text: 'ggRPC 请求转发重写', link: '/docs/dashboard/plugins/grpc-proxy_rewrite' },
      { text: 'IP 黑白名单', link: '/docs/dashboard/plugins/ip_restriction' },
      { text: '流量控制', link: '/docs/dashboard/plugins/rate_limiting' },
      { text: '鉴全', link: '/docs/dashboard/plugins/auth' },
      { text: '响应重写', link: '/docs/dashboard/plugins/response_rewrite' },
      { text: 'API 熔断', link: '/docs/dashboard/plugins/circuit_breaker' },
      { text: '跨域 CORS', link: '/docs/dashboard/plugins/cors' },
      { text: 'gzip 压缩', link: '/docs/dashboard/plugins/gzip' },
      { text: 'access-log', link: '/docs/dashboard/plugins/access_log' },
      { text: 'prometheus', link: '/docs/dashboard/plugins/prometheus' },
      { text: 'Http 协议转 gRPC 协议插件', link: '/docs/dashboard/plugins/http-to-grpc' },
      { text: 'gRPC 协议转 Http 协议插件', link: '/docs/dashboard/plugins/grpc-to-http' },
      { text: 'prometheus', link: '/docs/dashboard/plugins/proxy_mirror' },
    ],
  },
]
